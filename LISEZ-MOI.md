...
- **Vitrine** : ton profil de collectionneur. « Mes cartes à l'honneur » pour choisir jusqu'à 9 cartes (avec recherche) ; les 10 plus précieuses s'affichent en dessous. « Personnaliser » pour le thème, les cadres, la mise en page et ton **pseudo** (unique : « Valider » vérifie qu'il est libre).
