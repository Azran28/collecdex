...
- **Mes objectifs** (bouton « Objectifs » dans Mon Dex, ou section de l'accueil) : trois onglets.
  ...
  - **Liste de souhaits** : les cartes que tu cherches. Ouvre une carte que tu n'as pas et appuie sur « ♡ Je la cherche » ; elle porte alors un petit cœur rose dans les séries. Une carte capturée sort toute seule de la liste. Elle servira aussi pour les futurs échanges.
