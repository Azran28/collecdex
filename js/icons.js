...
App.icons = (() => {
  const P = {
    ...
    rafale: '<rect x="10" y="4" width="9" height="13" rx="1.6"/><path d="M7 6.5v11.5a1.5 1.5 0 0 0 1.5 1.5H16M4 9v11.5A1.5 1.5 0 0 0 5.5 22H13"/>',
    coin: '<circle cx="12" cy="12" r="8.5"/><circle cx="12" cy="12" r="5.2"/><path d="M12 9.3v5.4M10.4 10.6h2.6a1.1 1.1 0 0 1 0 2.2h-2"/>',
    shop: '<path d="M4 9.5 5.5 4h13L20 9.5"/><path d="M4 9.5a2.7 2.7 0 0 0 5.3 0 2.7 2.7 0 0 0 5.4 0 2.7 2.7 0 0 0 5.3 0"/><path d="M5.5 12v8h13v-8M10 20v-4.5h4V20"/>',
